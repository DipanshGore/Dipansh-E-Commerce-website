      ...
      <div className="flex flex-wrap justify-center gap-8 px-5">
        {loading ? (
          state.map(({ title, image, description, price }, index) => (
            <div
              key={index}
              className="bg-white shadow-md rounded-lg p-6 w-[320px] h-[500px] flex flex-col items-center border border-gray-300 hover:shadow-xl transition-transform transform hover:scale-105"
            >
